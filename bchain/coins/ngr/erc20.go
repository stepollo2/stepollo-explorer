...
// EnergiTypeGetErc20ContractInfo returns information about ERC20 contract
func (b *EnergiRPC) EnergiTypeGetErc20ContractInfo(contractDesc bchain.AddressDescriptor) (*bchain.Erc20Contract, error) {
...
// EnergiTypeGetErc20ContractBalance returns balance of ERC20 contract for given address
func (b *EnergiRPC) EnergiTypeGetErc20ContractBalance(addrDesc, contractDesc bchain.AddressDescriptor) (*big.Int, error) {
